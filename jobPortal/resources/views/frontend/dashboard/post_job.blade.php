@if (Auth::user())
    ...
    @employer
        ...
        <body style="background-color: var(--pxpMainColorLight);">
                        ...
                        <div class="row mt-4 mt-lg-5">
                            <div class="col-xxl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="pxp-company-job-title" class="form-control"
                                        placeholder="Add title">
                                </div>
                            </div>
                            <div class="col-md-6 col-xxl-3">
                                <label for="pxp-company-job-location" class="form-label">Location</label>
                                <input type="text" id="pxp-company-job-location" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xxl-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="pxp-company-job-experience" class="form-control"
            ...
            <script src="../../../cdn.jsdelivr.net/npm/bootstrap%405.1.1/dist/js/bootstrap.bundle.min.js"
