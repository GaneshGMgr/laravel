        ...
        <body style="background-color: var(--pxpMainColorLight);">
            ...
            <div class="pxp-dashboard-content">
                ...
                <div class="pxp-dashboard-content-details">
                    ...
                    <form action="{{route('save.post.job')}}" method="post">
                        <div class="row mt-4 mt-lg-5">
                            <div class="col-xxl-8">
                                <div class="mb-3">
                                    <label for="pxp-company-name" class="form-label">Company name</label>
                                    <input type="text" id="pxp-company-name" name="name" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="tel" id="pxp-company-phone" class="form-control"
                                                placeholder="(+12) 345 6789" name="phone">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-xxl-4">
                                ...
                                <div class="pxp-company-cover mb-3">
                                    <input type="file" id="pxp-company-cover-choose-file" accept="image/*" name="featured_image">
                                    <label for="pxp-company-cover-choose-file" class="pxp-cover"><span>Upload Cover
                                            Image</span></label>
                                </div>
                                <div class="pxp-company-logo mb-3">
                                    <input type="file" id="pxp-company-logo-choose-file" accept="image/*" name="logo">
                                    <label for="pxp-company-logo-choose-file"
                                        class="pxp-cover"><span>Upload<br>Logo</span></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="pxp-company-about" placeholder="Type your info here..."></textarea>
                        </div>
                ...
                <form>
                    <div class="row mt-4 mt-lg-5">
                        <div class="col-xxl-8">
                            <div class="mb-3">
                                ...
                                <input type="text" id="pxp-candidate-name" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" id="pxp-candidate-phone" class="form-control"
                        ...
                        <div class="col-xxl-4">
                            ...
                            <div class="pxp-candidate-cover mb-3">
                                ...
                                <label for="pxp-candidate-cover-choose-file" class="pxp-cover"><span>Upload Cover
                                        Image</span></label>
                            </div>
                            <div class="pxp-candidate-photo mb-3">
                                ...
                                <label for="pxp-candidate-photo-choose-file"
                                    class="pxp-cover"><span>Upload<br>Photo</span></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mt-lg-5">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle">
                                <tbody>
                                    <tr>
                                        <td style="width: 30%;">
                                            <div class="pxp-candidate-dashboard-experience-title">Senior UI/UX Designer
                                            </div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-company">Adobe Corporation
                                            </div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-time">2005 - 2013</div>
                                        </td>
                                        <td>
                                            <div class="pxp-dashboard-table-options">
                                                <ul class="list-unstyled">
                                                    <li><button title="Edit"><span
                        ...
                        <div class="row mt-3 mt-lg-4">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="pxp-candidate-work-title" class="form-control"
                                        placeholder="E.g. Web Designer">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="pxp-candidate-work-company" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="pxp-candidate-work-time" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control pxp-smaller" id="pxp-candidate-work-about"
                    ...
                    <div class="mt-4 mt-lg-5">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle">
                                <tbody>
                                    <tr>
                                        <td style="width: 30%;">
                                            <div class="pxp-candidate-dashboard-experience-title">Architecure</div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-school">Politehnica
                                                University of Timisoara: Bachelor of Architecture</div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-time">2011 - 2017</div>
                                        </td>
                                        <td>
                                            <div class="pxp-dashboard-table-options">
                                                <ul class="list-unstyled">
                                    ...
                                    <tr>
                                        <td style="width: 30%;">
                                            <div class="pxp-candidate-dashboard-experience-title">Front End Web
                                                Developer</div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-school">Udacity Nanodegree
                                                Program</div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-time">2020 - 2020</div>
                                        </td>
                                        <td>
                                            <div class="pxp-dashboard-table-options">
                                                <ul class="list-unstyled">
                                    ...
                                    <tr>
                                        <td style="width: 30%;">
                                            <div class="pxp-candidate-dashboard-experience-title">Build Responsive Real
                                                World Websites with HTML5 and CSS3</div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-company">Udemy</div>
                                        </td>
                                        <td style="width: 25%;">
                                            <div class="pxp-candidate-dashboard-experience-time">2021 - 2021</div>
                                        </td>
                                        <td>
                                            <div class="pxp-dashboard-table-options">
                                                <ul class="list-unstyled">
                        ...
                        <div class="row mt-3 mt-lg-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="pxp-candidate-edu-time" class="form-control"
                                        placeholder="E.g. 2005 - 2013">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control pxp-smaller" id="pxp-candidate-edu-about"
                                placeholder="Type a short description here..."></textarea>
                        </div>
