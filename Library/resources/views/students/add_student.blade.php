...
@endif
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                <!--begin::Label-->
                                                <label class="fs-5 fw-semibold mb-2">Student ID</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                        ...
                                        <div class="d-flex flex-column mb-5 fv-row">
                                            <!--begin::Label-->
                                            <label class="fs-5 fw-semibold mb-2">Faculty</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" placeholder="" name="faculty" />
                                            <!--end::Input-->
