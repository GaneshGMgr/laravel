...
class streamController extends Controller
{
    ...
    public function index(){
        $stream=DB::table('stream')->get();
        return view('backend.stream.index',compact('stream'));
    }
    public function datatables(Request $request): JsonResponse
    {
        ...
        /*Total records*/
        $totalRecords = Stream::select('count(*) as allcount')->count();
        $query = Stream::orderBy($columnName, $columnSortOrder)


        ->where('stream.name', 'like', '%' . $searchValue . '%')
        ...
        foreach ($records as $record) {
            ...
            $data_arr[] = array(
                ...
                'action' => "<a href='". route('edit.stream', $record->slug)."'
    ...
    public function add_stream(){
        ...
        return view('backend.stream.add_stream' );

        }

        public function save_stream(Request $request): JsonResponse
        {
        ...
        {
            $edit_stream = DB::table('stream')
                ->where('slug', $slug)->first();

                return view('backend.stream.edit',compact('edit_stream'));
        ...
        public function removeItem(Request $request)
        {
            ...
            try{
                $item = Stream::where('slug',$request->slug)->first();
                if (!$item) {
