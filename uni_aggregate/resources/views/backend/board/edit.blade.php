...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Consultancy</h4>
        ...
        <form id="add_consultancy" autocomplete="off" action="{{ route('save.edit.board',$edit_board->slug) }}" method="POST"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 item" style="margin: 10px">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$edit_board->name}}"
