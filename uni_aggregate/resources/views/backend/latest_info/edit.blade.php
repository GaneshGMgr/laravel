...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form id="add_info" autocomplete="off" action="{{ route('update.info',$edit_info->slug) }}" method="POST"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 item" style="margin: 10px">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter level name" value="{{$edit_info->name}}" required>
                                <div class="invalid-feedback">Please Enter a Title.</div>
                            </div>

                            <div style="margin: 10px">
                                <label for="" class="form-label required-label">Creator Name</label>
                                <input type="text" class="form-control" name="creator_name" placeholder="Enter creator's name" value="{{$edit_info->creator_name}}" required>

                            </div>
                            <div style="margin: 10px">
                                <label for="" class="form-label required-label">Url</label>
                                <input type="url" class="form-control" name="url" placeholder="Enter Url" value="{{$edit_info->url}}" required>
