...
<head>
    ...
    <!-- jsvectormap css -->
    <link href="{{ asset('assets/backend/libs/jsvectormap/css/jsvectormap.min.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/backend/js/app.css') }}">

    <link href="{{ asset('assets/backend/datatables/dataTables.bootstrap4.css') }}" rel="stylesheet" type="text/css" />
...
<body>
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="{{ asset('assets/backend/images/sidebar/img-1.jpg') }}" alt=""
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="{{ asset('assets/backend/images/sidebar/img-2.jpg') }}" alt=""
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="{{ asset('assets/backend/images/sidebar/img-3.jpg') }}" alt=""
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="{{ asset('assets/backend/images/sidebar/img-4.jpg') }}" alt=""
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                        </div>
    ...
    <script type="text/javascript"
        src="{{ asset('assets/backend/libs/choices.js/public/assets/scripts/choices.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/backend/datatables/jquery.dataTables.js') }}"></script>
    <script src="{{ asset('assets/backend/datatables/dataTables.bootstrap4.js') }}"></script>
