...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form id="add_course" autocomplete="off" action="{{ route('save.edit.course_master',$edit_course_master->slug) }}" method="POST"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 item" style="margin: 10px">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$edit_course_master->name}}"
                            ...
                            <div style="margin: 10px">
                                ...
                                <select name="country" class="form-select" id="select_2_country">
                                    ...
                                    @foreach (country() as $countries)
                                        <option value="{{ $countries->id }}" {{$edit_course_master->country_id?'selected':''}}>{{ $countries->name }}</option>
                                    @endforeach
                                </select>
