...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		/**
		 * Fire callback functions and trigger blog. Note that the loop over the callback
	 ...
	 * fnDrawCallback. This may be useful for binding blog or performing calculations when
	 ...
	 * bound blog, added DOM nodes, etc.
