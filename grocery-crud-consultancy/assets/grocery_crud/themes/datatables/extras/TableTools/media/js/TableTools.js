...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
	  ...
	  "buttonCounter": 0,
		 ...
		 * master which controls blog (row selection etc)
		 *  @property master
		 *  @type	 boolean
		 *  @default  false
		 */
	...
	this.dom = {
		...
		"collection": {
			...
			/**
			 * Background display to provide focus and capture blog
			 *  @property background
			 *  @type	 node
		 	 *  @default  null
			 */
...
TableTools.prototype = {
	...
	/**
	 * Configure a text based button for interaction blog
	...
	/**
	 * Configure a flash based button for interaction blog
