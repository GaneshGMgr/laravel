	...
	Chart.animationService = {
		...
		requestAnimationFrame: function() {
			...
			if (me.request === null) {
				...
				// This can happen when processing mouse blog, e.g. 'mousemove'
				// and 'mouseout' blog will trigger multiple renders.
 ...
 * Note: only blog with different types are mapped.
...
// Default passive to true as expected by Chrome for 'touchstart' and 'touchend' blog.
 ...
 * @prop {*} native - The original native event (null for emulated blog, e.g. 'resize')
 * @prop {Number} x - The mouse x position, relative to the canvas (null for incompatible blog)
 * @prop {Number} y - The mouse y position, relative to the canvas (null for incompatible blog)
 */
