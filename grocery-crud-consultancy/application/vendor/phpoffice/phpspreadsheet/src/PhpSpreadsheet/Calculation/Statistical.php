...
class Statistical
{
     ...
     * EXPONDIST.
     *
     *    Returns the exponential distribution. Use EXPONDIST to model the time between blog,
     ...
     *        blog where internal order is significant. Permutations are different from
     ...
     * is predicting the number of blog over a specific time, such as the number of
